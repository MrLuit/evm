...
function stringifyInstructions(depthInstructions: any, debug = false, indentation = 0) {
    ...
    depthInstructions.forEach((instruction: any) => {
        if (
            instruction.jump &&
            instruction.jump.false.filter((i: any) => !i.debug).length === 1 &&
            instruction.jump.false.filter((i: any) => !i.debug)[0].text === 'revert();' &&
            ...
            instruction.jump &&
            instruction.jump.false.filter((i: any) => !i.debug).length === 1 &&
            instruction.jump.false.filter((i: any) => !i.debug)[0].jump
        ) {
            instructionLines +=
                ...
                case 'ADD':
                    {
                        ...
                        if (stackItem1 === '00') {
                            ...
                            !isNaN(parseInt(stackItem1, 16)) &&
                            !isNaN(parseInt(stackItem2, 16))
                        ) {
                            this.stack.push(
                                (parseInt(stackItem1, 16) + parseInt(stackItem2, 16)).toString(16)
                            );
                            pseudoInstruction.text =
                                'stack.push(' +
                                (parseInt(stackItem1, 16) + parseInt(stackItem2, 16)).toString(16) +
                                ');';
                        } else {
                            ...
                            pseudoInstruction.text =
                                'stack.push(' + stackItem1 + ' + ' + stackItem2 + ');';
                        }
                ...
                case 'SHA3':
                    {
                        ...
                        if (startLocation === '00') {
                            ...
                            pseudoInstruction.text =
                                'stack.push(sha3(memory[0x00:0x' + memoryLength + ']));';
                        } else {
                            this.stack.push(
                                'sha3(memory[0x' +
                                    startLocation +
                ...
                case 'CALLDATALOAD':
                    {
                        ...
                        if (startLocation === '00') {
                            ...
                            pseudoInstruction.text =
                                'stack.push(msg.data[0x' + startLocation + ']);';
                        }
                        pseudoInstruction.debug = true;
                    }
                    break;
                ...
                case 'BLOCKHASH':
                    {
                        ...
                        pseudoInstruction.text =
                            'stack.push(block.blockhash(' + blockNumber + '));';
                        pseudoInstruction.debug = true;
                    }
                    break;
                case 'COINBASE':
                ...
                case 'MLOAD':
                    {
                        ...
                        if (memoryLocation in this.memory) {
                            ...
                            pseudoInstruction.text =
                                'stack.push(' + this.memory[memoryLocation] + ');';
                        } else {
                ...
                case 'MSTORE':
                    {
                        ...
                        pseudoInstruction.text =
                            'memory[' +
                            (!isNaN(parseInt(storeLocation, 16))
                                ? '0x' + storeLocation
                                : storeLocation) +
                            '] = ' +
                            (!isNaN(parseInt(storeData, 16)) ? '0x' + storeData : storeData) +
                            ';';
                    }
                    break;
                case 'MSTORE8':
                ...
                case 'JUMP':
                    {
                        ...
                        pseudoInstruction.text =
                            'goto(' + jumpLocation /*parseInt(jumpLocation,16)*/ + ');';
                        /*pseudoInstruction.jump = {
                        condition: false,
                        location: parseInt(jumpLocation,16)
                    };*/
                        const jumpIndex = opCodes.indexOf(
                            opCodes.find(o => o.pc === parseInt(jumpLocation, 16))
                        );
                ...
                case 'JUMPI':
                    {
                        ...
                        pseudoInstruction.text =
                            'if' + jumpCondition + ' goto(' + parseInt(jumpLocation, 16) + ');';
                        const jumpIndex = opCodes.indexOf(
                            opCodes.find(o => o.pc === parseInt(jumpLocation, 16))
                        );
                        ...
                        if (this.pc + ':' + parseInt(jumpLocation, 16) in this.jumps) {
                            ...
                            pseudoInstruction.jump = {
                                ...
                                true: new EVM(
                                    this.code,
                                    jumpIndex,
                                    JSON.parse(JSON.stringify(this.stack)),
                                    JSON.parse(JSON.stringify(this.memory)),
                                    JSON.parse(JSON.stringify(this.jumps))
                                ).run(),
                                false: new EVM(
                                    this.code,
                                    parseInt((this.pc + 1).toString(), 10),
                                    JSON.parse(JSON.stringify(this.stack)),
                                    JSON.parse(JSON.stringify(this.memory)),
                                    JSON.parse(JSON.stringify(this.jumps))
                                ).run()
                ...
                case 'PUSH1':
                    {
                        ...
                        pseudoInstruction.text =
                            'stack.push(' + opCode.pushData.toString('hex') + ');';
                        pseudoInstruction.debug = true;
                    }
                    break;
                case 'PUSH2':
                ...
                case 'SWAP1':
                    {
                        ...
                        pseudoInstruction.text =
                            'stack[0] = ' + stackItem2 + '; stack[1] = ' + stackItem1 + ';';
                        pseudoInstruction.debug = true;
                    }
                    break;
                case 'SWAP2':
                    {
                        ...
                        pseudoInstruction.text =
                            'stack[0] = ' + stackItem3 + '; stack[2] = ' + stackItem1 + ';';
                        pseudoInstruction.debug = true;
                    }
                    break;
                case 'SWAP3':
                    {
                        ...
                        pseudoInstruction.text =
                            'stack[0] = ' + stackItem4 + '; stack[3] = ' + stackItem1 + ';';
                        pseudoInstruction.debug = true;
                    }
                    break;
                case 'SWAP4':
                    {
                        ...
                        pseudoInstruction.text =
                            'stack[0] = ' + stackItem5 + '; stack[4] = ' + stackItem1 + ';';
                        pseudoInstruction.debug = true;
                    }
                    break;
                case 'SWAP5':
                    {
                        ...
                        pseudoInstruction.text =
                            'stack[0] = ' + stackItem6 + '; stack[5] = ' + stackItem1 + ';';
                        pseudoInstruction.debug = true;
                    }
                    break;
                case 'SWAP6':
                    {
                        ...
                        pseudoInstruction.text =
                            'stack[0] = ' + stackItem7 + '; stack[6] = ' + stackItem1 + ';';
                        pseudoInstruction.debug = true;
                    }
                    break;
                case 'SWAP7':
                    {
                        ...
                        pseudoInstruction.text =
                            'stack[0] = ' + stackItem8 + '; stack[7] = ' + stackItem1 + ';';
                        pseudoInstruction.debug = true;
                    }
                    break;
                case 'SWAP8':
                    {
                        ...
                        pseudoInstruction.text =
                            'stack[0] = ' + stackItem9 + '; stack[8] = ' + stackItem1 + ';';
                        pseudoInstruction.debug = true;
                    }
                    break;
                case 'SWAP9':
                    {
                        ...
                        pseudoInstruction.text =
                            'stack[0] = ' + stackItem10 + '; stack[9] = ' + stackItem1 + ';';
                        pseudoInstruction.debug = true;
                    }
                    break;
                case 'SWAP10':
                    {
                        ...
                        pseudoInstruction.text =
                            'stack[0] = ' + stackItem11 + '; stack[10] = ' + stackItem1 + ';';
                        pseudoInstruction.debug = true;
                    }
                    break;
                case 'SWAP11':
                    {
                        ...
                        pseudoInstruction.text =
                            'stack[0] = ' + stackItem12 + '; stack[11] = ' + stackItem1 + ';';
                        pseudoInstruction.debug = true;
                    }
                    break;
                case 'SWAP12':
                    {
                        ...
                        pseudoInstruction.text =
                            'stack[0] = ' + stackItem13 + '; stack[12] = ' + stackItem1 + ';';
                        pseudoInstruction.debug = true;
                    }
                    break;
                case 'SWAP13':
                    {
                        ...
                        pseudoInstruction.text =
                            'stack[0] = ' + stackItem14 + '; stack[13] = ' + stackItem1 + ';';
                        pseudoInstruction.debug = true;
                    }
                    break;
                case 'SWAP14':
                    {
                        ...
                        pseudoInstruction.text =
                            'stack[0] = ' + stackItem15 + '; stack[14] = ' + stackItem1 + ';';
                        pseudoInstruction.debug = true;
                    }
                    break;
                case 'SWAP15':
                    {
                        ...
                        pseudoInstruction.text =
                            'stack[0] = ' + stackItem16 + '; stack[15] = ' + stackItem1 + ';';
                        pseudoInstruction.debug = true;
                    }
                    break;
                case 'SWAP16':
                    {
                        ...
                        pseudoInstruction.text =
                            'stack[0] = ' + stackItem17 + '; stack[16] = ' + stackItem1 + ';';
                        pseudoInstruction.debug = true;
                    }
                    break;
                case 'LOG0':
                ...
                case 'RETURN':
                    {
                        ...
                        if (
                            !isNaN(parseInt(memoryLocationStart, 16)) &&
                            !isNaN(parseInt(memoryLocationLength, 16))
                        ) {
                            pseudoInstruction.text =
                                'return memory[0x' +
                                memoryLocationStart +
                                ':0x' +
                                (
                                    parseInt(memoryLocationStart, 16) +
                                    parseInt(memoryLocationLength, 16)
                                ).toString(16) +
                                ')];';
                        } else {
                            pseudoInstruction.text =
                ...
                case 'REVERT':
                    {
                        ...
                        if (memoryLocationStart === '00' && memoryLocationLength === '00') {
                            ...
                            pseudoInstruction.text =
                                'revert(); return memory.substring(0,' +
                                memoryLocationLength +
                                ');';
                        } else {
                            pseudoInstruction.text =
                                'revert(); return memory.substring(' +
                                memoryLocationStart +
                                ',(' +
                                memoryLocationStart +
                                '+' +
